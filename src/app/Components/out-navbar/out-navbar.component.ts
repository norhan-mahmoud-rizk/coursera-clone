...
@Component({
  ...
  imports: [RouterModule,FormsModule,CommonModule,TranslateModule,LoginRegisterFormDialogComponent,],
    templateUrl: './out-navbar.component.html',
  styleUrl: './out-navbar.component.scss',
  animations: [
    trigger('badgeBounce', [
...
export class OutNavbarComponent implements OnInit {
 ...
 searchValue: string = '';
  ...
  gotoOnline(){
    this.router.navigate(['/onlinedegree']);
  }
  gotoCareers(){
    this.router.navigate(['/careercourses']);
  }
}
